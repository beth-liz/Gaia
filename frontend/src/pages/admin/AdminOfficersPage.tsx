...
import { ShieldAlert, Edit2, Trash2, Power, CheckCircle2, AlertCircle } from "lucide-react";
...
const AdminOfficersPage: React.FC = () => {
  ...
  const openEditModal = (officer: any) => {
    ...
    setStationId(officer.station_id || (stations[0]?.id ?? ""));
  ...
  const columns: Column<any>[] = [
    ...
    },
    {
      ...
      sortable: true,
      cell: (o) => <span className="font-medium text-emerald-800/80">{o.district_name || "Wayanad"}, {o.state_name || "Kerala"}</span>,
    },
    {
      header: "Duty Status",
